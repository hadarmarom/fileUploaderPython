...
#     http.server.test(HandlerClass, ServerClass,port=8080,addr='localhost')
...
# # # def test(HandlerClass = SimpleHTTPRequestHandler,
# # #          ServerClass = BaseHTTPRequestHandler):
# # #     BaseHTTPServer.test(HandlerClass, ServerClass)
# # def test(HandlerClass=SimpleHTTPRequestHandler, ServerClass=BaseHTTPRequestHandler):
# #     # BaseHTTPServer.test(HandlerClass, ServerClass)
...
# #         # print('self', dir(self))
# #         # self.wfile.write('hello Hadar!!'.encode())
